            ...
            <div class="modal-content">
                ...
                <form action="{{ route('data.store', []) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="data">Pilih File Gambar</label>
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="badge py-1 border-0 badge-primary" type="button" data-toggle="modal" data-target="#lihatgambar{{ $item->iddata }}">
                                                <i class="fa fa-eye"></i>
                                                Lihat Gambar
                                            </button>
                                        </td>
                                    ...
                                    <div id="lihatgambar{{ $item->iddata }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="my-modal-title">Gambar</h5>
                                                    <button class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                    <img src="{{ url('/gambar', [$item->namadata]) }}" width="100%" alt="">
                                                </div>
                                                <div class="modal-footer">
